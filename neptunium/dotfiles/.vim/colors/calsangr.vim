" Modified By:         https://github.com/callumcarmicheal/
" Original Plugin:     https://github.com/zacanger/angr.vim
" Description: angr.vim theme
" Maintainer:  zacanger, Callum Carmicheal
...
let g:colors_name = 'calsangr'

" Changed bg from 262626 to 121212
hi Normal guifg=#e5e5e5 ctermfg=253 guibg=#121212 gui=NONE cterm=NONE
...
" Pmenu {{{1
hi Pmenu      guifg=#e4e4e4 ctermfg=254 guibg=#3a3a3a ctermbg=235 gui=NONE cterm=NONE
hi PmenuSel   ctermbg=1 guifg=#000000 guibg=#1f82cd
hi PmenuSbar  ctermbg=0 guibg=#d6d6d6

" ALE Error Messages {{{1
hi ALEErrorMsg    guifg=#e5786d ctermfg=255 guibg=#3a3a3a ctermbg=161  gui=NONE cterm=NONE
hi ALEWarningSign guifg=#fde76e ctermfg=255 guibg=#3a3a3a ctermbg=161  gui=NONE cterm=NONE
hi ALEInfoSign    guifg=#b5d3f3 ctermfg=255 guibg=#3a3a3a ctermbg=161  gui=NONE cterm=NONE
